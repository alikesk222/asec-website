...
<head>
    ...
    <title>Departmanlar - ASEC Kulübü</title>
...
<body>
    ...
    <main>
        <section class="teams-header">
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <p>ASEC Kulübü bünyesinde faaliyet gösteren uzman departmanlarımız</p>
        ...
        <section class="teams-grid">
            <div class="container">
                <!-- 1. Sıra: Siber Güvenlik ve Yazılım Geliştirme -->
                ...
                <!-- 2. Sıra: Yapay Zeka ve Veri Bilimi -->
                <div class="departments-row">
                    <!-- Yapay Zeka Departmanı -->
                    <div class="team-card">
                        <div class="team-banner">
                ...
                <!-- 3. Sıra: Ağ ve Sistem ve Dijital Tasarım -->
                <div class="departments-row">
                    <!-- Ağ ve Sistem Departmanı -->
                    <div class="team-card">
                        <div class="team-banner">
                ...
                <!-- 4. Sıra: Sosyal Medya Departmanı -->
                <div class="departments-row">
        ...
        <section class="technical-team">
            <div class="container">
                <div class="section-title">
                    <h2>Teknik Ekibimiz</h2>
                    <p>ASEC Kulübü'nün teknik altyapısını yöneten değerli ekip üyelerimiz</p>
                </div>
                    ...
                    <div class="team-card">
                        ...
                        <div class="team-content">
                            <div class="team-members">
                                <div class="member-card">
                                    <div class="member-image">
                                        <img src="images/team/default-profile.jpg" alt="Ali Kesik">
                                    </div>
                                    <div class="member-info">
                                        <h4>Ali Kesik</h4>
                                        <p class="member-role">Teknik Uzman</p>
                                        <div class="member-social">
                                            <a href="https://www.linkedin.com/in/ali-kesik" target="_blank"><i class="fab fa-linkedin"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="team-card">
                        ...
                        <div class="team-content">
                            <div class="team-members">
                                <div class="member-card">
                                    <div class="member-image">
                                        <img src="images/team/default-profile.jpg" alt="Alaaddin Koyuncu">
                                    </div>
                                    <div class="member-info">
                                        <h4>Alaaddin Koyuncu</h4>
                                        <p class="member-role">Teknik Koordinatör</p>
                                        <div class="member-social">
                                            <a href="https://www.linkedin.com/in/alaaddin-koyuncu" target="_blank"><i class="fab fa-linkedin"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="team-card">
                        ...
                        <div class="team-content">
                            <div class="team-members">
                                <div class="member-card">
                                    <div class="member-image">
                                        <img src="images/team/default-profile.jpg" alt="Nilgün Binnur Keskin">
uz                                    </div>
                                    <div class="member-info">
                                        <h4>Nilgün Binnur Keskin</h4>
                                        <p class="member-role">Teknik danışman</p>
                                        <div class="member-social">
                                            <a href="https://www.linkedin.com/in/nilgun-binnur-keskin" target="_blank"><i class="fab fa-linkedin"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
